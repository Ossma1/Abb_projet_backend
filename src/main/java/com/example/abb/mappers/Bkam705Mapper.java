...
public interface Bkam705Mapper {
    Bkam705Mapper INSTANCE = Mappers.getMapper(Bkam705Mapper.class);
    ...
    BkamEntity toBkam705Entity(CorrespondanceBancaire705 source);

    default int calculerNombreChampsRenseidnes(CorrespondanceBancaire705 source) {
        int count = 0;
