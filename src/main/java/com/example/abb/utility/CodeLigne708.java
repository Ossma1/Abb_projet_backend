...
public class CodeLigne708 {
    ...
    static {
        ...
        codeMapping.put("CL-02-1", "CL08");
        codeMapping.put("CL-02-2", "CL09");
        codeMapping.put("CL-02-3", "CL10");
        codeMapping.put("CL-02-4", "CL11");
        codeMapping.put("CL-02-4-1", "CL12");
        codeMapping.put("CL-02-4-2", "CL13");
        codeMapping.put("CL3", "CL14");
        codeMapping.put("PDT-01", "PP01");
        codeMapping.put("PDT-02", "PP02");
        codeMapping.put("PDT-03", "PP03");
        ...
        codeMapping.put("Autres-01-01", "AT02");
        codeMapping.put("Autres-01-02", "AT03");
        codeMapping.put("Autres-01-03", "AT04");
        codeMapping.put("Autres-02", "AT05");
        codeMapping.put("Autres-02-01", "AT06");
        codeMapping.put("Autres-02-02", "AT07");
        codeMapping.put("Autres-02-03", "AT08");
